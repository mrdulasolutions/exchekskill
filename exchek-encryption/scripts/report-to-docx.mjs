#!/usr/bin/env node
/**
 * Convert an ExChek encryption memo markdown (.md) to Word (.docx).
 * Usage: node report-to-docx.mjs <path-to-memo.md>
 * Output: <path-to-memo.docx> in the same directory.
...
async function main() {
  ...
  if (!mdPath) {
    console.error("Usage: node report-to-docx.mjs <path-to-memo.md>");
    process.exit(1);
  }
